...
func (r *RESTD) Run(u uhppote.IUHPPOTE, devices []uhppote.Device, l *log.Logger) {
	...
	d := dispatcher{
		...
		handlers: []handler{
			handler{regexp.MustCompile("^/device$"), http.MethodGet, device.GetDevices},
			handler{regexp.MustCompile("^/device/[0-9]+$"), http.MethodGet, device.GetDevice},
			handler{regexp.MustCompile("^/device/[0-9]+/status$"), http.MethodGet, device.GetStatus},
			handler{regexp.MustCompile("^/device/[0-9]+/time$"), http.MethodGet, device.GetTime},
			handler{regexp.MustCompile("^/device/[0-9]+/time$"), http.MethodPut, device.SetTime},
			handler{regexp.MustCompile("^/device/[0-9]+/door/[1-4]$"), http.MethodGet, device.GetDoor},
			handler{regexp.MustCompile("^/device/[0-9]+/door/[1-4]/swipes$"), http.MethodPost, device.OpenDoor},
			handler{regexp.MustCompile("^/device/[0-9]+/door/[1-4]/delay$"), http.MethodPut, device.SetDoorDelay},
			handler{regexp.MustCompile("^/device/[0-9]+/door/[1-4]/control$"), http.MethodPut, device.SetDoorControl},

			handler{regexp.MustCompile("^/device/[0-9]+/cards$"), http.MethodGet, device.GetCards},
			handler{regexp.MustCompile("^/device/[0-9]+/cards$"), http.MethodDelete, device.DeleteCards},
			handler{regexp.MustCompile("^/device/[0-9]+/card/[0-9]+$"), http.MethodGet, device.GetCard},
			handler{regexp.MustCompile("^/device/[0-9]+/card/[0-9]+$"), http.MethodPut, device.PutCard},
			handler{regexp.MustCompile("^/device/[0-9]+/card/[0-9]+$"), http.MethodDelete, device.DeleteCard},

			handler{regexp.MustCompile("^/device/[0-9]+/time-profile/[0-9]+$"), http.MethodGet, device.GetTimeProfile},
			handler{regexp.MustCompile("^/device/[0-9]+/time-profile/[0-9]+$"), http.MethodPut, device.PutTimeProfile},
			handler{regexp.MustCompile("^/device/[0-9]+/time-profiles"), http.MethodGet, device.GetTimeProfiles},
			handler{regexp.MustCompile("^/device/[0-9]+/time-profiles"), http.MethodPut, device.PutTimeProfiles},
			handler{regexp.MustCompile("^/device/[0-9]+/time-profiles"), http.MethodDelete, device.ClearTimeProfiles},

			handler{regexp.MustCompile("^/device/[0-9]+/tasklist"), http.MethodPut, device.PutTaskList},

			handler{regexp.MustCompile("^/device/[0-9]+/events$"), http.MethodGet, device.GetEvents},
			handler{regexp.MustCompile("^/device/[0-9]+/events/([0-9]+)$"), http.MethodGet, device.GetEvents},
			handler{regexp.MustCompile("^/device/[0-9]+/event/([0-9]+|first|last|current|next)$"), http.MethodGet, device.GetEvent},
			handler{regexp.MustCompile("^/device/[0-9]+/special-events$"), http.MethodPut, device.SpecialEvents},

			handler{regexp.MustCompile("^/acl$"), http.MethodGet, acl.GetACL},
			handler{regexp.MustCompile("^/acl$"), http.MethodPut, acl.PutACL},
			handler{regexp.MustCompile("^/acl/card/[0-9]+$"), http.MethodGet, acl.Show},
			handler{regexp.MustCompile("^/acl/card/[0-9]+/door/\\S.*$"), http.MethodPut, acl.Grant},
			handler{regexp.MustCompile("^/acl/card/[0-9]+/door/\\S.*$"), http.MethodDelete, acl.Revoke},
		},
